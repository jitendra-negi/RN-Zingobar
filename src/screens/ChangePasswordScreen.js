    ...
    <OtrixContainer>
      ...
      <OtrixContent>
        ...
        >
          <Input
            variant="outline"
            placeholder={strings.reset_password.placeholder_old_password}
        ...
        >
          <Input
            variant="outline"
            placeholder={strings.reset_password.placeholder_new_password}
            style={[GlobalStyles.textInputStyle]}
            onChangeText={(value) =>
        ...
        >
          <Input
            variant="outline"
            placeholder={strings.reset_password.placeholder_confirm_password}
            style={[GlobalStyles.textInputStyle]}
            onChangeText={(value) => {
