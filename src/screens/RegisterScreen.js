...
function RegisterScreen(props) {
  ...
  const validate = () => {
    ...
    if (firstName == null || firstName == "") {
      ...
      setData({
        ...formData,
        type: "error",
        message: "Please attach DOB proof",
        loading: false,
      });
    return false;
  }
  ...
  const register = () => {
    if (validate()) {
      ...
      try {
        getApi.postData("user/registeruser", sendData).then((response) => {
    ...
    <OtrixContainer>
      ...
      <OtrixContent>
        ...
        >
          <Input
            variant="outline"
            placeholder={strings.commoninput.placeholder_first_name}
        ...
        >
          <Input
            variant="outline"
            placeholder={strings.commoninput.placeholder_last_name}
            style={GlobalStyles.textInputStyle}
            onChangeText={(value) =>
        ...
        >
          <Input
            variant="outline"
            placeholder={strings.commoninput.placeholder_confirm_password}
            style={GlobalStyles.textInputStyle}
            onChangeText={(value) => {
        ...
        <FormControl
          style={{ backgroundColor: Colors().lightWhite }}
          isRequired
          isInvalid={submited && "age" in errors}
        >
          <Input
            variant="outline"
            placeholder={strings.commoninput.placeholder_age}
            style={GlobalStyles.textInputStyle}
            onChangeText={(value) => {
              setData({ ...formData, submited: false, age: value }),
                delete errors.age;
            }}
          />
          <FormControl.ErrorMessage leftIcon={<InfoOutlineIcon size="xs" />}>
        ...
        <View style={styles.container}>
          ...
          {showDatePicker && (
            <DateOfBirthPicker onImageSelected={handleImageSelected} />
          )}
        </View>
        ...
        >
          <Text style={GlobalStyles.buttonText}>
            {strings.registration.button_register}
          </Text>
        </Button>
        <OtrixDivider size={"md"} />
        ...
        <View style={styles.registerView}>
          <Text style={styles.registerTxt}>
            {strings.registration.label_login_info}{" "}
          </Text>
          <TouchableOpacity
          ...
          >
            <Text style={styles.signupTxt}>
              {" "}
              {strings.registration.button_login}{" "}
            </Text>
          </TouchableOpacity>
        </View>
        <OtrixDivider size={"md"} />
