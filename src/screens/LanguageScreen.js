    ...
    <OtrixContainer customStyles={{ backgroundColor: Colors().light_white }}>
      ...
      <OtrixHeader customStyles={{ backgroundColor: Colors().light_white }}>
        ...
        <View style={[GlobalStyles.headerCenter, { flex: 1 }]}>
          <Text style={GlobalStyles.headingTxt}>
            {" "}
            {strings.setting.label_language}
          </Text>
        </View>
      </OtrixHeader>
      ...
      <TouchableOpacity
        style={[
          styles.langBox,
          {
            borderWidth: language == "en" ? 1 : 0.1,
            borderColor:
              language == "en" ? Colors().themeColor : Colors().custom_gray,
          },
        ]}
      ...
      >
        <Text
          style={[
            ...
            {
              color:
                language == "en" ? Colors().themeColor : Colors().text_color,
            },
          ]}
        >
          {" "}
          {strings.language_screen.english}
        </Text>
      </TouchableOpacity>
