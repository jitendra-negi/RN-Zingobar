...
function ForgotPasswordScreen(props) {
  ...
  const submit = () => {
    if (validate()) {
      ...
      try {
        getApi.postData("user/forgotPassword", sendData).then((response) => {
  ...
  return (
    <OtrixContainer>
      ...
      <OtrixHeader>
        <TouchableOpacity
          style={[GlobalStyles.headerLeft, { flex: 0.05 }]}
        ...
        <View
          style={[
            ...
            { flex: 0.95, justifyContent: "center", alignItems: "flex-start" },
          ]}
        >
