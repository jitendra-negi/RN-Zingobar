...
function OrderDetailScreen(props) {
    ...
    useEffect(() => {
        ...
        try {
            ...
            logfunction("Error order timeline", error)
            setState({
                ...state,
                loading: false,
            });
                ...
                <View style={styles.addressBox} showsHorizontalScrollIndicator={false} vertical={true}>
                    ...
                    {/* {timelineData != null &&
                        <View style={{ width: '100%', height: '8%', backgroundColor: 'white', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <View style={{ width: 30, height: 30, backgroundColor: 'white', marginLeft: 10, borderRadius: 15, borderWidth: 6, borderColor: 'rgb(45,156,219)' }}>

                            </View>
                            <View style={{ width: 80, height: 40, marginLeft: 10, justifyContent: 'center', alignItems: 'center' }}>
                                <Text >{timelineData[0].title}</Text>
                            </View>
                            <View style={{ width: 80, height: 40, marginLeft: 10, justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ color: '#818181' }} >{timelineData[0].description}</Text>
                            </View>
                        </View>
                    }  */}
                    <OtrixDivider size={"md"} />
                    ...
                    <View style={styles.cartContent} >
                        {
                            orderData.products.length > 0 && orderData.products.map((item, index) =>
                                <View >
                                    ...
                                    <View style={[GlobalStyles.horizontalLine, { marginTop: 5 }]}></View>
                                    <OtrixDivider size={"md"} />
