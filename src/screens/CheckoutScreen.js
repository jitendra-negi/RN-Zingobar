    ...
    <OtrixContainer customStyles={{ backgroundColor: Colors().light_white }}>
      ...
      {!loading && step == 1 && (
        <>
          ...
          <Text style={styles.deliveryTitle}>
            {strings.checkout.delivery_address}
          </Text>
          <OtrixDivider size={"md"} />
          {addresses.length > 0 && (
                  ...
                  >
                    ...
                    <TouchableOpacity
                      style={[
                        ...
                        {
                          bottom:
                            selctedAddress == item.id ? hp("11%") : hp("10%"),
                        },
                      ]}
      ...
      {!loading && addresses.length == 0 && (
        ...
        >
          <Text style={[styles.addressTxt]}>
            ...
            {strings.checkout.add_new_address}{" "}
          </Text>
        </TouchableOpacity>
      )}
      ...
      {!loading && step == 1 && (
        <>
          ...
          <OtrixDivider size={"md"} />
          <Text style={styles.deliveryTitle}>
            {strings.checkout.shipping_method}
          </Text>
          <OtrixDivider size={"md"} />
      ...
      {!loading && step == 2 && (
        <View style={{ marginHorizontal: wp("4%") }}>
          ...
          <Text style={styles.paymentMethodTitle}>
            {strings.checkout.payment_methods}
          </Text>
          <OtrixDivider size={"sm"} />
      ...
      {!loading && step == 2 && (
        <View style={{ marginHorizontal: wp("4%") }}>
          <Text style={[styles.summayTitle, { left: wp("1.5%") }]}>
            {strings.checkout.order_comments}
          </Text>
          <OtrixDivider size={"sm"} />
            ...
            >
              <Text
                style={[
                  ...
                  {
                    fontSize:
                      I18nManager.isRTL == true ? wp("3.8%") : wp("4.8%"),
                  },
                ]}
              >
