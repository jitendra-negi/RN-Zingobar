...
function CheckoutScreen(props) {
  ...
  const proceedToPay = () => {
    if (selectedShipping != 0 && selctedAddress) {
      ...
      getApi
        .postData("user/selectShipping/" + selectedShipping, [])
        .then((response) => {
    ...
    <OtrixContainer customStyles={{ backgroundColor: Colors().light_white }}>
      ...
      {!loading && step == 1 && (
        <>
          ...
          <Text style={styles.deliveryTitle}>
            {strings.chekout.delivery_address}
          </Text>
          <OtrixDivider size={"md"} />
          {addresses.length > 0 && (
      ...
      {!loading && addresses.length == 0 && (
        ...
        >
          <Text style={[styles.addressTxt]}>
            ...
            {strings.chekout.add_new_address}{" "}
          </Text>
        </TouchableOpacity>
      )}
      ...
      {!loading && step == 1 && (
        <>
          ...
          <OtrixDivider size={"md"} />
          <Text style={styles.deliveryTitle}>
            {strings.chekout.shipping_method}
          </Text>
          <OtrixDivider size={"md"} />
      ...
      {!loading && step == 2 && (
        <View style={{ marginHorizontal: wp("4%") }}>
          ...
          <Text style={styles.paymentMethodTitle}>
            {strings.chekout.payment_methods}
          </Text>
          <OtrixDivider size={"sm"} />
      ...
      {!loading && step == 2 && (
        <View style={{ marginHorizontal: wp("4%") }}>
          <Text style={[styles.summayTitle, { left: wp("1.5%") }]}>
            {strings.chekout.order_comments}
          </Text>
          <OtrixDivider size={"sm"} />
          <FormControl isRequired>
            <Input
              ...
              value={comment}
              placeholder={
                strings.checkout.enter_order_comments + " (optional)"
              }
      ...
      {!loading && step == 2 && (
        <OtrixContent>
          <OtrixDivider size={"sm"} />
          <Text style={styles.summayTitle}>
            {strings.chekout.order_summary}
          </Text>
          <OtrixDivider size={"sm"} />
