    ...
    <OtrixContainer customStyles={{ backgroundColor: Colors().light_white }}>
      ...
      <OtrixContent>
        ...
        >
          ...
          <View style={styles.center}>
            <Text style={styles.listTitle}>
              {strings.setting.label_notification}
            </Text>
          </View>
          <View style={styles.rightSide}>
            <MatIcon
        ...
        >
          ...
          <View style={styles.center}>
            <Text style={styles.listTitle}>
              {strings.setting.terms_conditions}
            </Text>
          </View>
          <View style={styles.rightSide}>
            <MatIcon
        ...
        >
          ...
          <View style={styles.center}>
            <Text style={styles.listTitle}>
              {strings.setting.privacy_policy}
            </Text>
          </View>
          <View style={styles.rightSide}>
            <MatIcon
        ...
        >
          ...
          <View style={styles.center}>
            <Text style={styles.listTitle}>
              {strings.setting.shipping_delivery}
            </Text>
          </View>
          <View style={styles.rightSide}>
            <MatIcon
