                    ...
                    <View style={styles.cartContent} key={data.cart_id}>
                        <View style={styles.cartBox} >
                            ...
                            <View style={styles.infromationView}>
                                ...
                                <Text style={styles.price}>{CURRENCY}{data.special > 0 ? data.special : data.totalPrice} </Text>
                            ...
                            <View style={styles.plusminus}>
                                    <TouchableOpacity style={{ marginRight: wp('2.5%'), padding: 4 }} onPress={() => data.quantity != 1 ? props.decrementItem(data.cart_id, data.id, data.quantity):props.deleteItem(data.cart_id)}>
