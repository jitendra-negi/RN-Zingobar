...
function AddAdressComponent(props) {
    ...
    const { name, country, city, address1, address2,state, postcode,mobileNumber, submited } = formData;
        ...
        <View>
            ...
            <View style={styles.modelView}>
                ...
                <OtrixHeader customStyles={{ backgroundColor: Colors().white }}>
                    <TouchableOpacity style={[GlobalStyles.headerLeft,{flex:0.3,alignItems:'flex-start'}]} onPress={() => props.closeAdd()}>
