        ...
        <OtrixHeader customStyles={{ backgroundColor: Colors().white }}>
          ...
          <View style={[GlobalStyles.headerCenter]}>
            <Text style={GlobalStyles.headingTxt}>
              {strings.manage_address.add_address}
            </Text>
          </View>
        ...
        <View style={styles.contentView}>
          <FormControl isRequired isInvalid={submited && "name" in errors}>
            <Input
              variant="outline"
              value={name}
              placeholder={strings.commoninput.name}
          ...
          <FormControl isRequired isInvalid={submited && "city" in errors}>
            <Input
              variant="outline"
              value={city}
              placeholder={strings.commoninput.city}
              style={GlobalStyles.textInputStyle}
              onChangeText={(value) => {
          ...
          <FormControl isRequired isInvalid={submited && "postcode" in errors}>
            <Input
              variant="outline"
              value={postcode}
              placeholder={strings.commoninput.postcode}
              style={GlobalStyles.textInputStyle}
              onChangeText={(value) => {
          ...
          <FormControl isRequired isInvalid={submited && "address1" in errors}>
            <TextArea
              value={address1}
              variant="outline"
              placeholder={strings.commoninput.address_1}
          ...
          <FormControl isRequired>
            <Input
              variant="outline"
              value={address2}
              placeholder={strings.commoninput.address_2}
              style={GlobalStyles.textAreaInputStyle}
              onChangeText={(value) =>
                setData({ ...formData, address2: value })
              }
            />
          </FormControl>
        </View>
